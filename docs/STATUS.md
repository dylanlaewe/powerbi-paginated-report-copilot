...
Candidates 01, 02, 03b, and 04b are functionally accepted; Candidates 03 and 04 are rejected and preserved. Candidate 04c now instantiates a replacement title and six-row dataset while retaining the accepted Report Builder `Tablix1` subtree byte-for-byte. All local validation passes; independent Windows open, Preview, row, and subtotal verification are pending. The branch remains unmerged and untagged; Candidate 05 is not generated.
