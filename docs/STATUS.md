...
Candidates 01 and 02 are accepted after independent Windows validation. Candidate 03 now derives directly from unchanged Candidate 02 and adds only a clear Region group-header row with alphabetical Region sorting and SaleDate/Salesperson detail sorting. Local XML, XSD, dataset, hierarchy, group, sort, field, type, width, and baseline-checksum validation passes. Candidate 03 Report Builder open and Preview remain pending; the branch remains unmerged and untagged.
