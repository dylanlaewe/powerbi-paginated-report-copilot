...
Candidates 01, 02, 03b, 04b, 04c, and 05 are accepted; Candidates 03 and 04 are rejected and preserved. Candidate 05 passed checksum, open, Design, Preview, six-row preservation, all three Region subtotals, and exactly one correct `61 / $15,990 / $6,250` Grand Total without repair or errors. Pagination was not supplied. Candidate 06 is the final compatibility step and requires proven Report Builder-authored pagination structures; the branch remains unmerged and untagged.
