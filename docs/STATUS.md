...
Candidates 01, 02, 03b, 04b, and 04c are accepted; Candidates 03 and 04 are rejected and preserved. Candidate 04c proves template instantiation and previewed correctly on one page. Candidate 05 is blocked—not generated—because the branch has no accepted Report Builder-authored report-level grand-total seed. Exact Windows seed-creation instructions are recorded. The branch remains unmerged and untagged.
